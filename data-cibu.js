...
const cibuExams = [
    ...
    // ========== 15. 2020年10月 ==========
    {
        ...
        explanations: {
            ...
            '34': '【正确答案：H. pointing】空格所在句为"start asking, 'What is that?' when ___ to objects or pictures"（当指着物体或图片时，开始问"那是什么？"）。"when + 现在分词"是英语中表示"当……时"的常见结构，空格需要一个现在分词。选项H "pointing"（指着）符合语境，"when pointing to objects"（当指着物体时）说明家长应该指着物体问孩子。干扰项：I "pick"（捡起）是动词原形，不能与"when"直接连用；F "build"也是原形；A "link"也是原形。',
